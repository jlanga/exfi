...
class TestCoordinatesToVariables(TestCase):
    """exfi.io._coordinate_str_to_tuple(coordinates):
    (string) -> (string, int, int)
    """
    def test_empty_string(self):
        """exfi.io._coordinate_str_to_tuple: case empty"""
        with self.assertRaises(ValueError):
            _coordinate_str_to_tuple("")

    def test_incorrect_string(self):
        """exfi.io._coordinate_str_to_tuple: case incorrect"""
        with self.assertRaises(IndexError):
            _coordinate_str_to_tuple("ENSDART00000161035:1")

    def test_correct_string(self):
        """exfi.io._coordinate_str_to_tuple: case correct"""
        self.assertEqual(
    ...
    def test_messy_string(self):
        """exfi.io._coordinate_str_to_tuple: messy case"""
        self.assertEqual(
