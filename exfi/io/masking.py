...
def _soft_mask(exon_dict: dict, overlap_dict: dict) -> dict:
...
def _hard_mask(exon_dict: dict, overlap_dict: dict) -> dict:
...
def _mask(exon_dict: dict, overlap_dict: dict, masking: str = "none") -> dict:
